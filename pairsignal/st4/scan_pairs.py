...
жизни серии (>~90 дней) история тонкая и результат смещён (склейки серий нет).
  ...
  python -m pairsignal.st4.scan_pairs --days 60
  python -m pairsignal.st4.scan_pairs --days 90 --stop-sigma 4 --pairs SBRF:SBPR
"""
...
OUT_JSON = Path(__file__).resolve().parent.parent / "out" / "st4_scan_pairs.json"
